                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    ...
                                    <li class="active"><a href="notice.php">Notices<span class="sr-only">(current)</span></a></li>
                                    ...
                                    <li><a href="contact-login.html">Login/Contact Us</a></li>
                                </ul>
                            </div>
                            <!-- /.navbar-collapse -->
                        </nav>
        ...
        <section id="footer">
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-6">
                        <div class="copyright">
                            <p>@ 2019 - Design By <span><a href="">Gulkshah Khan</a></span></p>
                        </div>
                    </div>
                </div>
                <!--End of row-->
